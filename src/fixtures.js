...
export const fixFixture = {
  ...
  fix: {
    summary: "Mask the card number before logging — only the last 4 digits remain.",
...
+  console.log("Charging card ****" + card.number.slice(-4) + " for " + amount);`,
  ...
  sandbox: { testsPassed: true, testOutput: "Tests: 6 passed, 6 total", attempts: 2 },
};
...
export const allowFixture = {
  ...
  sandbox: { testsPassed: true, testOutput: "Tests: 6 passed, 6 total", attempts: 0 },
};
...
export const escalateFixture = {
  ...
  violation: {
    ...
    file: "src/server.js",
    line: 31,
    description: "A high-entropy string is assigned to a const — could be a key or could be a placeholder.",
  },
  fix: {

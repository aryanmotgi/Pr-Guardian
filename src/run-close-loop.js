	...
	fix: {
		pr: {
			...
			violation: {
				...
				line: 18,
				reason:
					"Logs the full payment card number (PAN) — violates our no-PAN-in-logs rule",
	...
	allow: {
		pr: {
			...
			violation: {
				...
				line: 7,
				reason:
					"4242 4242 4242 4242 is a well-known fake test card used as fixture data — not a real leak",
			},
		},
